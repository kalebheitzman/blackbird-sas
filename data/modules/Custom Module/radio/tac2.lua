...
function draw()
    ...
    sasl.gl.drawRectangle(0, 0, 82, 30, button)
    ...
    if radio_mode_ref == 0 then
        ...
        sasl.gl.drawText(roboto, 64, 10, channel, 12, true, false, TEXT_ALIGN_RIGHT, white)
        sasl.gl.drawText(roboto, 65, 10, mode, 12, true, false, TEXT_ALIGN_LEFT, white)
