...
-- Function to calculate turn parameters
function calculateTurnParameters(coord1, coord2, coord3, trueAirspeed, bankAngle, windDirection, windSpeed)
    ...
    local startTurnDistance = turnRadius * math.tan(math.abs(windCorrectionAngle - math.abs(turnAngle) / 2)) *
